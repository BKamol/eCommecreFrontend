        ...
        <div className="flex flex-row gap-4 items-center justify-between">
          ...
          <div className="flex flex-col gap-1 flex-grow">
            <div className="flex flex-row items-center justify-between">
                ...
                <button 
                    onClick={() => onRemove(item.id, item.colors[0], item.sizes)}
            ...
            <div className="flex flex-row items-center justify-between">
              ...
              <div className="flex flex-row justify-between items-center min-w-[110px] max-w-[150px] gap-4 bg-[#f0f0f0] rounded-[25px] px-4 py-1">
                <button 
                    onClick={() => onDecrease(item.id, item.colors[0], item.sizes)}
                ...
                <button 
                    onClick={() => onIncrease(item.id, item.colors[0], item.sizes)}
                    className="font-bold text-lg cursor-pointer"
                >
                    <Plus size={16} />
                </button>
